...
class IT06_TokensTtlRefreshTamperTvTest extends ITBase {
  ...
  @Test @DisplayName("M01:IT-06-001 AT TTL 満了 -> 401 *token_expired")
  void IT_06_001() throws Exception { /* TODO: 時刻操作 or 短TTL発行 */ }

  @Test @DisplayName("M01:IT-06-002 RTで refresh 成功（RTローテーション、tv据置）")
  void IT_06_002() throws Exception { /* TODO */ }

  @Test @DisplayName("M01:IT-06-003 RT 改竄 -> 401")
  void IT_06_003() throws Exception { /* TODO */ }

  @Test @DisplayName("M01:IT-06-004 logout_all 後 RT 使用 -> 401 /token/reused")
  void IT_06_004() throws Exception { /* TODO */ }

  @Test @DisplayName("M01:IT-06-005 kid/鍵束切替")
