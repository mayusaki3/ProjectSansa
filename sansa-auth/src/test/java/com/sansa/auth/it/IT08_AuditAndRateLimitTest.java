...
class IT08_AuditAndRateLimitTest extends ITBase {
  ...
  @Test @DisplayName("M01:IT-08-001 REGISTER 系の監査")
  void IT_08_001() { /* TODO: 監査出力のアサート方針（テスト用 Appender or TestSink） */ }

  @Test @DisplayName("M01:IT-08-002 LOGIN/LOGOUT/LOGOUT_ALL 監査")
  void IT_08_002() { /* TODO */ }

  @Test @DisplayName("M01:IT-08-003 MFA 監査")
  void IT_08_003() { /* TODO */ }

  @Test @DisplayName("M01:IT-08-004 pre-register のレート制限ヘッダ")
