...
### 特定クラス / メソッドのみ
```
mvn -q -Dspring.profiles.active=inmem -Dtest=AuthControllerTest test
mvn -q -Dspring.profiles.active=inmem -Dtest=AuthControllerTest#preRegister_validation test
```
